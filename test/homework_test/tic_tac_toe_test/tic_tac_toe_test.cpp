...
TEST_CASE("TicTacToe4 Test game over")
{
	TicTacToe4 board;
	REQUIRE(board.game_over() == false);
}
TEST_CASE("TicTacToe4 Test set first player X")
{
	TicTacToe4 board;
	board.start_game("X");
	REQUIRE(board.get_player() == "X");
}
TEST_CASE("TicTacToe4 Test set first player O")
{
	TicTacToe4 board;
	board.start_game("O");
	REQUIRE(board.get_player() == "O");
...
TEST_CASE("TicTacToe4 Test win diagnolly from top left")
{
	TicTacToe4 board;
	board.start_game("O");
	board.mark_board(1);//O
